...
/**
 * 根据请假天数是否小于3天判断流程分支的走向，在完成任务前通过taskId注入流程变量
 */
public class ProcessBranchSetVariableByTaskId {
    ...
    public static void testProcessByHolidayNum(Float num){
        ...
        for (String assignee:
            ...
            BaseActiveCompleteTask.completeTaskByAssigneeWithVariable(DEFINITION_KEY,assignee,map);
        }
    }
